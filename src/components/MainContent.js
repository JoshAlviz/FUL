		...
		<>
			<div className="pa5 bg-black-80">
				...
				<div className="flex flex-wrap items-center">
					...
					<p className="f3 lh-copy measure-wide w-100 w-50-l ph3 tl white">
				...
				<div className="flex flex-wrap items-center">
					<p className="f3 lh-copy measure-wide w-100 w-50-l ph3 tl order-2 order-1-l white">
